...
@SpringBootTest
class CmallSearcServerApplicationTests {
  ...
  put();
    ...
    public void put() throws IOException {
        ...
        for (PmsSearchSkuInfo pmsSearchSkuInfo : pmsSearchSkuInfos) {
            ...
            Index put = new Index.Builder(pmsSearchSkuInfo).index("cmall").type("PmsSkuInfo").id(pmsSearchSkuInfo.getId()+"").build();
            jestClient.execute(put);
            System.out.println("Price"+pmsSearchSkuInfo.getPrice());
        }
